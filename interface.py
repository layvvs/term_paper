...
from buttons_handler import ButtonsHandler
from db_processor import Insert
...
class Ui_MainWindow(object):
        ...
        def connections(self):
                btn_handler = ButtonsHandler(self.name_label, self.bpm_label, self.key_label, self.analyse_btn)
                self.open_file_btn.clicked.connect(lambda: btn_handler.open_file())
                self.analyse_btn.clicked.connect(lambda: btn_handler.analyze())
                ...
                self.go_to_library_btn.clicked.connect(lambda: Insert().insert(self.scrollArea))
